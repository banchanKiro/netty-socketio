...
public class WebSocketTransport extends ChannelInboundHandlerAdapter {
	...
	public WebSocketTransport(boolean isSsl, AuthorizeHandler authorizeHandler, Configuration configuration,
	...
	private void connectClient(final Channel channel, final UUID sessionId) {
		...
		if (client == null) {
			log.warn("Unauthorized client with sessionId: {} with ip: {}. Channel closed!", sessionId,
